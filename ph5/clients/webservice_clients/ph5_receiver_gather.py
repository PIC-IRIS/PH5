...
def process_arguments():
    ...
    required.add_argument('--location', '--loc',
                          ...
                          required=True)
    required.add_argument('--channel', '--cha',
...
def receiver_gather(arguments):
    ...
    cha = inventory[0][0]; # get channel in inventory
    ...
    for event in events:
        ...
        for trace in traces:
            ...
            trace.stats.distance = gps2dist_azimuth(
                                        ...
                                        cha.latitude, 
                                        cha.longitude)[0]
            stream.traces.append(trace)
    
    # Order the event traces by distance from the receiver
...
def main():
    try:
        ...
        gather = receiver_gather(arguments)
