...
class TestPH5toMSeed(unittest.TestCase):
    ...
    def test_get_nonrestricted_segments(self): 
        ...
        # nothing restricted
        restricted_list = []
        self.assertEqual(PH5toMSeed.get_nonrestricted_segments(station_to_cut_list, restricted_list), station_to_cut_list, "None restricted")
        
        # entirely restricted
        restricted_list = [ get_restricted_request_testcase(st, et) ]
        self.assertEqual(PH5toMSeed.get_nonrestricted_segments(station_to_cut_list, restricted_list), [], "All restricted")
        ...
        self.assertEqual(expected.__dict__, result[0].__dict__,  "Later half restricted")
        ...
        result = PH5toMSeed.get_nonrestricted_segments(station_to_cut_list, restricted_list)
        self.assertEqual(expected.__dict__, result[0].__dict__, msg="First half restricted")
        ...
        result = PH5toMSeed.get_nonrestricted_segments(station_to_cut_list, restricted_list)
        self.assertEqual(expected1.__dict__, result[0].__dict__, msg="Restricted inside of request. 1st Segment")
        self.assertEqual(expected2.__dict__, result[1].__dict__, msg="Restricted inside of request. 2nd Segment")
        ...
        self.assertEqual(expected1.__dict__, result[0].__dict__, msg="Restricted inside of request. 1st Segment")
        self.assertEqual(expected2.__dict__, result[1].__dict__, msg="Restricted inside of request. 2nd Segment")
        self.assertEqual(expected3.__dict__, result[2].__dict__, msg="Restricted inside of request. 3nd Segment")
