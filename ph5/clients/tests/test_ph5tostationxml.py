...
class TestPH5toStationXML(unittest.TestCase):
    ...
    def test_is_radial_intersection(self):
        ...
        self.assertTrue(PH5toStationXML.is_radial_intersection(34.946,
                                                               -106.457,
                                                               0, 1,
                                                               latitude,
                                                               longitude))
        self.assertTrue(PH5toStationXML.is_radial_intersection(34.946,
                                                               ...
                                                               longitude))
        # intersect ANMO
        self.assertTrue(PH5toStationXML.is_radial_intersection(46.195,
                                                               -121.553,
                                                               0, 17.623,
                                                               latitude,
                                                               longitude))
        ...
        self.assertTrue(PH5toStationXML.is_radial_intersection(35.174,
                                                               -91.846,
                                                               10, 14.377,
                                                               latitude,
                                                               longitude))
        # does not intersect ANMO
        self.assertFalse(PH5toStationXML.is_radial_intersection(46.195,
                                                                -121.553,
                                                                0, 3,
                                                                latitude,
                                                                longitude))

        self.assertFalse(PH5toStationXML.is_radial_intersection(31.915,
                                                                -106.282,
                                                                0, 0.752,
                                                                latitude,
                                                                longitude))
        # min radius is outside ANMO
        self.assertFalse(PH5toStationXML.is_radial_intersection(34.946,
                                                                -106.457,
                                                                1, 4,
                                                                latitude,
                                                                longitude))
