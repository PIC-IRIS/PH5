...
def write_events () :
    ...
    for sl in shot_lines :
        ...
        for e in EVENT_T[sl].rows :
            ...
            E = { 'id': e['id_s'], 'time': pictime, 'lat': e['location/Y/value_d'], 'lon': e['location/X/value_d'], 'elev': e['location/Z/value_d'], 'mag': e['size/value_d'], 'mag_units':e['size/units_s'], 'depth': e['depth/value_d'] }
            events.append (E)
