...
def general_header_block_1 () :
    ...
    BIN = construct.BitStruct ("BIN",
                               #
                               construct.BitField ("file_number", 16, swapped = swap),
                               #   8058 is IEEE 32 bit float 
                               construct.BitField ("data_sample_format_code", 16, swapped = swap),   
                               construct.BitField ("general_constant_1", 8, swapped = swap),
                               construct.BitField ("general_constant_2", 8, swapped = swap),
                               construct.BitField ("general_constant_3", 8, swapped = swap),
                               construct.BitField ("general_constant_4", 8, swapped = swap),
                               construct.BitField ("general_constant_5", 8, swapped = swap),
                               construct.BitField ("general_constant_6", 8, swapped = swap),
                               construct.BitField ("first_shot_point_year", 8, swapped = swap),
                               construct.BitField ("number_additional_general_header_blocks", 4, swapped = swap),
                               construct.BitField ("first_shot_point_doy", 12, swapped = swap),
                               construct.BitField ("first_shot_point_time_utc", 24, swapped = swap),
                               #   20 is Fairfield
                               construct.BitField ("manufactures_code", 8, swapped = swap),
                               construct.BitField ("manufactures_sn", 16, swapped = swap),
                               #   Traces written in superblocks. 0=No, 1=Yes
                               construct.BitField ("super_blocks", 8, swapped=swap),
                               construct.BitField ("user01", 16, swapped = swap),
                               #   Sample interval in 1/16 msec
                               construct.BitField ("base_scan_interval", 8, swapped = swap),
                               construct.BitField ("polarity_code", 4, swapped = swap),
                               construct.BitField ("user02", 12, swapped = swap),
                               construct.BitField ("record_type", 4, swapped = swap),
                               #   From time zero, 0.5 X 1.024 seconds, if 0xFFF look in general header block 2
                               construct.BitField ("record_length", 12, swapped = swap),
                               construct.BitField ("scan_types_per_record", 8, swapped = swap),
                               #   0xFF look in general header block 2
                               construct.BitField ("chan_sets_per_scan", 8, swapped = swap),
                               construct.BitField ("number_skew_blocks", 8, swapped = swap),
                               #   0xFF look in general header block 2
                               construct.BitField ("number_extended_header_blocks", 8, swapped = swap),
                               #   0xFF look in general header block 2
...
def general_header_block_2 () :
    ...
    BIN = construct.BitStruct ("BIN",
                               construct.BitField ("extended_file_number", 24, swapped = swap),
                               construct.BitField ("extended_chan_sets_per_scan_type", 16, swapped = swap),
                               construct.BitField ("extended_header_blocks", 16, swapped = swap),
                               #   External header blocks is 3 bytes in Fairfield 1.6. Append user01.
                               construct.BitField ("external_header_blocks", 24, swapped = swap),
                               #construct.BitField ("user01", 8, swapped=swap),
                               #   0x0106, or 0x0201
                               construct.BitField ("file_version_number", 16, swapped = swap),
                               construct.BitField ("number_general_trailer_blocks", 16, swapped = swap),
                               #   Record length in milliseconds
                               construct.BitField ("extended_record_length", 24, swapped = swap),
                               construct.BitField ("user02", 8, swapped = swap),
                               construct.BitField ("general_header_block_number", 8, swapped = swap),
                               construct.BitField ("user03", 8, swapped = swap),
                               #   2.1
                               construct.BitField ("sequence_number", 16, swapped=swap),
                               #   2.1
                               construct.BitField ("super_block_size", 32, swapped=swap),
...
def general_header_block_3 () :
    ...
    BIN = construct.BitStruct ("BIN",
                               construct.BitField ("extended_file_number", 24, swapped = swap),
                               construct.BitField ("source_line_number_int", 24, swapped = swap),
                               construct.BitField ("source_line_number_frac", 16, swapped = swap),
                               construct.BitField ("source_point_number_int", 24, swapped = swap),
                               construct.BitField ("source_point_number_frac", 16, swapped=swap),
                               construct.BitField ("source_point_index", 8, swapped = swap),
                               construct.BitField ("phase_control", 8, swapped = swap),
                               construct.BitField ("vibrator_type", 8, swapped = swap),
                               construct.BitField ("phase_angle", 16, swapped = swap),
                               construct.BitField ("general_header_block_number", 8, swapped = swap),
                               construct.BitField ("source_set_number", 8, swapped = swap),
...
def channel_set_descriptor () :
    ...
    BIN = construct.BitStruct ("BIN",
                               construct.BitField ("scan_type_number", 8, swapped = swap),
                               construct.BitField ("chan_set_number", 8, swapped = swap),
                               #   Times 2 is milliseconds
                               construct.BitField ("chan_set_start_time", 16, swapped = swap),
                               #   Times 2 is milliseconds
                               construct.BitField ("chan_set_end_time", 16, swapped = swap),
                               construct.BitField ("optional_mp_factor_extension_byte", 8, swapped = swap),
                               construct.BitField ("mp_factor_scaler_multiplier", 8, swapped = swap),
                               construct.BitField ("number_of_chans_in_chan_set", 16, swapped = swap),
                               construct.BitField ("chan_type_code", 4, swapped = swap),
                               construct.BitField ("user01", 4, swapped = swap),
                               construct.BitField ("number_sub-scans", 4, swapped = swap),
                               #   3 is fixed gain
                               construct.BitField ("gain_control_type", 4, swapped = swap),
                               construct.BitField ("alias_filter_freq", 16, swapped = swap),
                               construct.BitField ("alias_filter_slope_db", 16, swapped = swap),
                               construct.BitField ("low_cut_filter_freq", 16, swapped = swap),
                               construct.BitField ("low_cut_filter_slope_db", 16, swapped = swap),
                               construct.BitField ("notch_filter_freq", 16, swapped = swap),
                               construct.BitField ("second_notch_filter_freq", 16, swapped = swap),
                               construct.BitField ("third_notch_filter_freq", 16, swapped = swap),
                               construct.BitField ("extended_chan_set_number", 16, swapped = swap),
                               construct.BitField ("extended_header_flag", 4, swapped = swap),
                               #   Always 10 for Fairfield
                               construct.BitField ("number_trace_header_extensions", 4, swapped = swap),
                               construct.BitField ("vertical_stack_size", 8, swapped = swap),
                               construct.BitField ("streamer_cable_number", 8, swapped = swap),
...
def extended_header_1_shot () :
    BIN = construct.Struct ("BIN",
                            ...
                            construct.UBInt16 ("number_decimation_filter_coefficients"),
...
def extended_header_2 () :
    BIN = construct.Struct ("BIN",
                            ...
                            construct.UBInt8 ("clock_stop_method"),          #   Clock stop method
                                                                             #   0 - normal
                                                                             #   1 - storage full
                                                                             #   2 - power loss
                                                                             #   3 - reboot by command
                            construct.UBInt8 ("Frequency_drift"),            #   Frequency drift flag
                                                                             #   0 - not in spec
                                                                             #   1 - in spec
                            construct.UBInt8 ("oscillator_type"),            #   Oscillator type
                                                                             #   0 - control board
                                                                             #   1 - atomic
                                                                             #   2 - ovenized
                                                                             #   3 - double ovenized
                                                                             #   4 - disciplined
                            construct.UBInt8 ("collection_method"),          #   0 - normal (shots)
                            ...
                            construct.UBInt8 ("decimation_flag"),            #   Decimation flag
                                                                             #   0 - not decimated
                                                                             #   1 - decimated
...
def extended_header_2_test () :
    BIN = construct.Struct ("BIN",
                            ...
                            construct.UBInt32 ("first_test_oscillator_attenuation"),
                            construct.UBInt32 ("second_test_oscillator_attenuation"),
                            construct.UBInt32 ("start_delay_usec"),
                            construct.UBInt32 ("dc_filter_flag"),            #   00 - No filter, 01 - Apply filter
                            construct.BFloat32 ("dc_filter_frequency"),
                            construct.UBInt32 ("preamp_path"),               #   See page 9 of format spec
...
def extended_header_4 () :
    BIN = construct.Struct ("BIN",
                            construct.BFloat32 ("coef01"),               #   Decimation filter coefficients
...
def external_header_shot_blocks () :
    BIN = construct.Struct ("BIN",
                            ...
                            construct.UBInt32 ("shot_point_Y"),
                            construct.UBInt32 ("shot_point_depth"),
                            construct.UBInt8 ("shot_info_source"),   #   See format spec ZSystem
...
def trace_header () :
    ...
    BIN = construct.BitStruct ("BIN",
                               construct.BitField ("tape_file", 16, swapped = swap),
                               construct.BitField ("scan_type", 8, swapped = swap),
                               construct.BitField ("channel_set", 8, swapped = swap),
                               construct.BitField ("trace_number", 16, swapped = swap),
                               construct.BitField ("first_timing_word", 24, swapped = swap),
                               construct.BitField ("trace_extension_blocks", 8, swapped = swap),
                               construct.BitField ("sample_skew_value", 8, swapped = swap),
                               construct.BitField ("trace_edit_code", 8, swapped = swap),
                               construct.BitField ("time_break_window", 24, swapped = swap),
                               construct.BitField ("extended_channel_set", 16, swapped = swap),
                               construct.BitField ("extended_file_number", 24, swapped = swap)
                               )
    return BIN
#
...
def trace_header_1 () :
    ...
    BIN = construct.BitStruct ("BIN",
                               construct.BitField ("receiver_line", 24, swapped = swap),
                               construct.BitField ("receiver_point", 24, swapped = swap),
                               construct.BitField ("receiver_point_index", 8, swapped = swap),
                               construct.BitField ("samples_per_trace", 24, swapped = swap),
                               construct.BitField ("extended_receiver_line_number", 40, swapped = swap),
                               construct.BitField ("extended_receiver_point_number", 40, swapped = swap),
                               construct.BitField ("sensor_type", 8, swapped = swap),                     #   00 - Not defined
                                                                                                          #   01 - Hydrophone
                                ...
                                construct.BitField ("reserved01", 88, swapped = swap)
                               )
    return BIN
...
def trace_header_2 () :
    BIN = construct.Struct ("BIN",
                            ...
                            construct.UBInt8 ("final_shot_info"),                        #   0 - Undefined
                                                                                         #   1 - preplan
                                                                                         #   2 - as shot
                                                                                         #   3 - post processed
...
def trace_header_4 () :
    BIN = construct.Struct ("BIN",
                            ...
                            construct.UBInt8 ("record_type"),                           #   0x8 - normal seismic data record
...
def trace_header_5_acquisition_data_block () :
    BIN = construct.Struct ("BIN",
                            ...
                            construct.UBInt8 ("acquisition_stop_method"),   #   See ZSystem format spec
...
def trace_header_8 () :
    BIN = construct.Struct ("BIN",
                            ...
                            construct.UBInt32 ("pre_amp_path"),                    #   0 - external input selected (default)
                            ...
                            construct.UBInt32 ("oscillator_siganl_type")           #   0 - test oscillator path open
...
def trace_header_9 () :
    BIN = construct.Struct ("BIN",
                            construct.UBInt32 ("generator_signal_type"),           #   0 - pattern address ramp
